      ...
      <div class="operate-con clearfix">
          <div class="search-con">
              <el-form class="clearfix"  label-width="65px">
                  ...
                  <el-form-item label="姓名" style="width:auto"  >
      ...
      <div class="table-con">
        <div>
            <el-table :data="tableData" v-if="tableData && tableData.length > 0" border>
              <el-table-column prop="id" label="ID" width="80" align="center" v-if="!isDate"></el-table-column>
              ...
              <el-table-column prop="save_date" label="入股日期" align="center" v-if="!isDate"></el-table-column>
              <el-table-column prop="num" label="入股次数" align="center" v-if="isDate"></el-table-column>
