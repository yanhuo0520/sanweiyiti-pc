<template>
    <div class="drawList"  v-loading="loading">
      <div class="breadcrumb-con">
        <img class="left-icon" src="../../images/breadcrumb-left-icon.png" alt="">
          <div class="breadcrumb-info">
              <el-breadcrumb separator-class="el-icon-arrow-right">
                  <el-breadcrumb-item>股金业务</el-breadcrumb-item>
                  <el-breadcrumb-item  class="breadcrumb-tit">股金退股列表</el-breadcrumb-item>
              </el-breadcrumb>
          </div>
        ...
        <div class="operate-con clearfix">
            <div class="search-con">
                <el-form class="clearfix"  label-width="65px">
                    <el-form-item label="退股日期" style="width:auto"  >
        ...
        <div class="table-con">
          <div>
              <el-table :data="tableData" v-if="tableData && tableData.length > 0" border>
                ...
                <el-table-column prop="log_date" label="退股时间" align="center"></el-table-column>
                <el-table-column prop="name" label="社员名称" align="center"></el-table-column>
                <el-table-column prop="passbook_num" label="社员账号" align="center"></el-table-column>
                <!-- <el-table-column prop="term_name" label="股金种类" ></el-table-column>
                <el-table-column prop="term_name" label="支取分红" ></el-table-column> -->
                <el-table-column prop="log_money" label="退股金额" align="center"></el-table-column>
              </el-table>
