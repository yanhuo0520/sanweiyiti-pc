          ...
          <div class="breadcrumb-con">
              ...
              <div class="breadcrumb-info">
                  <el-breadcrumb separator-class="el-icon-arrow-right">
                      ...
                      <el-breadcrumb-item  class="breadcrumb-tit">账户列表</el-breadcrumb-item>
                  </el-breadcrumb>
              </div>
          ...
          <div class="table-con">
            <div>
                <el-table :data="tableData" v-if="tableData && tableData.length > 0" border>
                    ...
                    <el-table-column prop="bonus_num" label="收益账号" align="center"></el-table-column>
...
export default {
  ...
  created() {
    window.addEventListener("message",(event)=>{
         if(event.data && event.data.path && event.data.path == 'accountListByIncome') {
  ...
  methods: {
    ...
    readBankNo() {
      ...
      this.ruleForm.card = ''
      setTimeout(() =>{
          document.getElementById('readIcIframeId').src='./static/autoGetCardSN.html?path=accountListByIncome';
      },500)
    },
    // 根据IC芯片卡号获取卡号
    getBankNo() {
