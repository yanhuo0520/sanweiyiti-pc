        ...
        <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="150px">
            ...
            <div class="form-item-con clearfix">
                ...
                <el-form-item label="是否预售:">
                  <template v-if="yushouRadio == 0">
                      <span>非预售</span>
                  </template>
                  <template v-if="yushouRadio == 1">
                      <span>预售</span>
                  </template>
                </el-form-item>
                ...
                <el-form-item label="预售时间:" v-if="yushouRadio == 1">
                    <el-date-picker
            ...
            <template v-if="specArr && specArr.length > 0">
                <el-table :data="specArr"  border  class="specData" >
                  ...
                  <el-table-column  width="180" v-if="ruleForm.spcifi && ruleForm.spcifi.length > 0 && ruleForm.spcifi[0].threeStylesTitle != ''" :label="ruleForm.spcifi[0].threeStylesTitle" align="center">
                   ...
                   <el-table-column label="阶梯价格" align="center">
                      <template slot-scope="scope">
                          <template v-if="scope.row.tiered && scope.row.tiered.length > 0">
                              <div v-for="(item,index) in scope.row.tiered" :key="index">
                                  <template v-if="item.most > 0">
                                      <span>{{item.least}} ~ {{item.most}}件: {{item.price}}元</span>
                                  </template>
                                  <template v-else>
                                      <span>{{item.least}}件以上: {{item.price}}元</span>
                                  </template>
                              </div>
                          </template>
                          <template v-else>
