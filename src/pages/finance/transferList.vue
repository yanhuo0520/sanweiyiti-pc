        ...
        <div class="breadcrumb-con">
              ...
              <div class="breadcrumb-info">
                  <el-breadcrumb separator-class="el-icon-arrow-right">
                      ...
                      <el-breadcrumb-item  class="breadcrumb-tit">转账审批管理</el-breadcrumb-item>
                  </el-breadcrumb>
              </div>
        ...
        <div class="search-con">
            <el-form class="clearfix"  label-width="80px">
                ...
                <el-form-item label="转账类型">
                    <el-input v-model="userName" placeholder="转出至别人银行卡" readonly></el-input>
                </el-form-item>
            ...
            <div class="table-con">
                <el-table :data="tableData" v-if="type==1 && tableData && tableData.length > 0" border>
                    <el-table-column prop="turn_bank_id" label="ID" align="center" width="80"></el-table-column>
                    <el-table-column prop="card" label="转出账户" align="center"></el-table-column>
                    <el-table-column prop="name" label="社员姓名" align="center" ></el-table-column>
                    <el-table-column prop="turn_bank_name" label="收款银行" align="center"></el-table-column>
                    <el-table-column prop="turn_bank_num" label="收款银行卡号" align="center"></el-table-column>
                    <!-- <el-table-column prop="turnin_card" label="转入账户/互助金账户" ></el-table-column> -->
                    <el-table-column prop="turn_bank_user" label="收款人姓名" align="center"></el-table-column>
                    <el-table-column prop="turnout_money" label="转账金额" align="center"></el-table-column>
                    <el-table-column prop="turn_note" label="转账附言" align="center"></el-table-column>
                    <el-table-column prop="turn_bank_name" label="转账单状态" align="center" >
                        ...
                        <template slot-scope="scope">
                            <template v-if="scope.row.status == 0">
                              <el-popover trigger="hover" placement="top" >
                                <p>驳回原因: {{scope.row.exam_note}}</p>
                                <div slot="reference" class="name-wrapper">
                                    <el-tag style="cursor: pointer" size="medium" type="danger">驳回</el-tag>
                                </div>
                              </el-popover>
                            </template>
                            ...
                            <template v-if="scope.row.status == 2">
                              <el-tag size="medium" type="warning">待审核</el-tag>
                            </template>
                        </template>
                    </el-table-column>
                    <el-table-column prop="worker_phone" label="转账方式" align="center">
                        <template slot-scope="scope">
                            转出至别人银行卡
                        </template>
                    </el-table-column>
                    <el-table-column prop="post_name" label="审批人" align="center"></el-table-column>
                    <el-table-column label="操作" align="center">
                        <template slot-scope="scope">
                            <el-button type="text" size="small" v-if="scope.row.status == 2 && isApprove && scope.row.verify==1" @click="toShenpi('shenpi',scope.row.turn_bank_id,2)">去审批</el-button>
                            ...
                            <el-button type="text" size="small" v-if="scope.row.status == 0 || scope.row.status == 1 && isLook || scope.row.status == 2 && scope.row.verify==2 && isLook" @click="toShenpi('detail',scope.row.turn_bank_id,2)">查看详情</el-button>
                        </template>
                    </el-table-column>
                </el-table>
