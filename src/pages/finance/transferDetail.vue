    ...
    <div class="transferDetail">
      <div style="display:flex;justify-content:space-between" class="breadcrumb-con">
        <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item>转账信息单</el-breadcrumb-item>
        </el-breadcrumb>
      ...
      <div class="tit-con">
        ...
        <el-form class="form-item-con"  label-width="80px">
            ...
            <el-form-item label="姓名：">
                ...
                <p style="color:red">备注：转账审核人必要时需要和转账人确认转账信息！</p>
        </el-form>
...
export default {
  ...
  activated() {
    ...
    if (this.$route.query.tag != undefined) {
      ...
      this.detail(this.$route.query.id, this.$route.query.type);
    }
  },
  methods: {
    // 返回上一页
