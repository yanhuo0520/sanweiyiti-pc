        ...
        <div class="table-con">
            <div>
                <el-table :data="tableData" v-if="tableData && tableData.length > 0" border>
                    ...
                    <el-table-column prop="card" label="合作社卡号" align="center"></el-table-column>
                    <el-table-column prop="name" label="社员姓名" align="center"></el-table-column>
                    <el-table-column prop="turnout_last_money" label="支取前余额" align="center"></el-table-column>
                    <el-table-column prop="turnout_money" label="支取金额" align="center"></el-table-column>
                    <el-table-column prop="turn_date" label="转账申请时间" align="center"></el-table-column>
                    <el-table-column prop="turn_bank_user" label="收款人姓名" align="center"></el-table-column>
                    <el-table-column prop="turn_bank_num" label="收款人银行卡账号" align="center"></el-table-column>
                    <el-table-column prop="turn_bank_name" label="收款人的银行名称" align="center"></el-table-column>
                    <el-table-column label="取款单状态" align="center">
                    ...
                    <el-table-column label="操作" align="center">
                        <template slot-scope="scope">
                            <el-button type="text" size="small" v-if="scope.row.status == 2 && isApprove && scope.row.verify==1" @click="toShenpi('shenpi',scope.row.turn_bank_id)">去审批</el-button>
                            ...
                            <el-button type="text" size="small" v-if="scope.row.status == 0 || scope.row.status == 1 && isLook || scope.row.status == 2 && scope.row.verify==2 && isLook" @click="toShenpi('detail',scope.row.turn_bank_id)">查看详情</el-button>
                        </template>
                    </el-table-column>
                </el-table>
