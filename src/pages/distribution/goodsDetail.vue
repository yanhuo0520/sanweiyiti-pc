        ...
        <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="150px">
            ...
            <div class="form-item-con clearfix">
                ...
                <el-form-item label="是否优选:">
                 ...
                 <el-form-item label="是否分销:">
                  <template v-if="fenxiaoRadio == 0">
                      <span>非分销商品</span>
                  </template>
                  <template v-if="fenxiaoRadio == 1">
                      <span>分销商品</span>
                  </template>
                </el-form-item>
            </div>
            ...
            <template v-if="specArr && specArr.length > 0">
                <el-table :data="specArr"  border  class="specData" >
                  ...
                  <el-table-column  width="160" v-if="ruleForm.spcifi && ruleForm.spcifi.length > 0 && ruleForm.spcifi[0].oneStylesTitle != ''" :label="ruleForm.spcifi[0].oneStylesTitle" align="center">
                      <template slot-scope="scope">
                          {{scope.row.oneStylesName}}
                      </template>
                  </el-table-column>
                  <el-table-column width="160" v-if="ruleForm.spcifi && ruleForm.spcifi.length > 0 && ruleForm.spcifi[0].twoStylesTitle != ''" :label="ruleForm.spcifi[0].twoStylesTitle" align="center">
                      <template slot-scope="scope">
                          {{scope.row.twoStylesName}}
                      </template>
                  </el-table-column>
                  <el-table-column  width="160" v-if="ruleForm.spcifi && ruleForm.spcifi.length > 0 && ruleForm.spcifi[0].threeStylesTitle != ''" :label="ruleForm.spcifi[0].threeStylesTitle" align="center">
                      <template slot-scope="scope">
                  ...
                  <el-table-column prop="discount_price" label="会员价" align="center">
                   ...
                   <el-table-column v-if="fenxiaoRadio == 1" prop="team_owner_money" label="分销金额" align="center">
                      <template slot-scope="scope">
                          <el-input v-model="scope.row.team_owner_money" readonly></el-input>
                      </template>
                  </el-table-column>
