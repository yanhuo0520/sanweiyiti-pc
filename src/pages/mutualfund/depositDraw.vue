    ...
    <div class="depositDraw">
        <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="100px">
            <div class="breadcrumb-con">
             ...
             <div class="form-item-con clearfix" style="margin-top:50px">
                <el-form-item label="互助金账号:" label-width="120px" prop="passbook_num">
                    <el-input v-model="ruleForm.passbook_num" placeholder="请输入互助金账号" clearable :readonly="isRead">
                        <template #append>
            ...
            <template v-if="info && info.relation_id">
                ...
                <p v-if="type==2 && isFind">定期总金额：{{info.regular_money}}</p>
                <p v-if="type==3 && isFind">活期总金额：{{info.money}}</p>
                ...
                <div class="form-item-con clearfix" v-if="type==3">
                    <el-form-item label="支取金额:">
                        <el-input v-model="drawMoney" placeholder="请输入支取金额" clearable @input="inputMoney" :readonly="isRead" type="number"></el-input>
                    </el-form-item>
        ...
        <div ref="print" class="print" style="position:fixed;top:0;left:0;right:0;bottom:0;width:100%;background:#fff;display:none;">
            <el-form ref="ruleForm" label-width="150px">
                ...
                <div class="form-item-con clearfix">
                    <el-form-item label="互助金账号:">
                        <el-input v-model="passbook_num" placeholder="请输入互助金账号" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="社员姓名:">
                        <el-input v-model="info.name" clearable readonly></el-input>
                    </el-form-item>
...
export default {
  ...
  methods: {
    ...
    inputMoney(){
        this.drawMoney = this.drawMoney.replace(/^(\-)*(\d+)\.(\d\d).*$/,'$1$2.$3')
    ...
    moneyAll(){
        ...
        this.ajax('fixedMoneyAll',{
            relation_id: this.info.relation_id,
