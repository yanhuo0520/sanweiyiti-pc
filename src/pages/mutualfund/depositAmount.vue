        ...
        <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="100px">
            <div class="breadcrumb-con">
             ...
             <div class="form-item-con clearfix" style="margin-top:50px">
                <el-form-item label="互助金账号:" prop="passbook_num">
              ...
              <div class="tit-con">
                ...
                <div class="form-item-con clearfix">
                    <el-form-item label="身份证号码:">
                        <el-input v-model="info.idcard"  readonly></el-input>
                    </el-form-item>
                    <el-form-item label="社员姓名:">
                        <el-input v-model="info.name" readonly></el-input>
                    </el-form-item>
                    <el-form-item label="家庭住址:">
                        <el-input :value="info.address ? info.address : info.native_place" readonly></el-input>
                    </el-form-item>
