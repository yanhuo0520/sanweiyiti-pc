<template>
    <div class="add-confrere">
        <div class="breadcrumb-con">
            <img class="left-icon" src="../../images/breadcrumb-left-icon.png" alt="">
            <div class="breadcrumb-info">
                <el-breadcrumb separator-class="el-icon-arrow-right">
                    <el-breadcrumb-item>基础信息</el-breadcrumb-item>
                    <el-breadcrumb-item  @click.native="goBack" class="breadcrumb-tit">社员建档</el-breadcrumb-item>
                    <el-breadcrumb-item v-if="confrere_attr"  class="breadcrumb-tit">{{confrere_attr == 1 ? '自然人' : (confrere_attr == 2 ? '机构/单位/企业法人' : '集体经济组织')}}</el-breadcrumb-item>
                </el-breadcrumb>
            </div>
            <div class="back-con" v-if="confrere_attr" @click="goBack">
				<img class="back-icon" src="../../images/breadcrumb-back-icon.png" alt="">
				<span class="back-text">返回</span>
			</div>
        </div>

        <div class="confrere-attr" v-if="!confrere_attr">
            <div class="tit">社员属性</div>
            <div class="attr-btn-con">
                <el-button type="primary" round  @click="changeConfrereAttr(1)" >自然人</el-button>
                <el-button type="success" round  @click="changeConfrereAttr(2)">机构/单位/企业法人</el-button>
                <el-button type="warning" round  @click="changeConfrereAttr(3)">集体经济组织</el-button>
            </div>
        </div>
        
        <el-form v-if="confrere_attr == 1" ref="ruleForm" :model="ruleForm" :rules="rules" style="margin-top: 0.5rem" label-width="100px">
            <div class="tit-con">
                <div class="shu"></div>
            ...
            <div class="form-item-con clearfix">
                <el-form-item  prop="idcard_just" class="idcard-item-con" style="height:auto">
                ...
                <el-form-item  prop="idcard_reverse" class="idcard-item-con" style="height:auto">
                   <div class="idcard-img-con">
                ...
                <el-form-item label="社员类型:" prop="coopera_cls">
                    <el-select v-model="ruleForm.coopera_cls" placeholder="请选择社员类型">
                ...
                <el-form-item label="身份证号码:" prop="idcard">
                    <el-input v-model="ruleForm.idcard" placeholder="请输入身份证号码" clearable>
                        <!-- <template #append>
                ...
                <el-form-item label="出生年月:" prop="birth_date">
                    <el-date-picker type="date" value-format="yyyy-MM-dd" placeholder="请选择社员出生年月" v-model="ruleForm.birth_date" style="width: 80%;"></el-date-picker>
                </el-form-item>
                <el-form-item label="籍贯:" prop="native_place">
                    <el-input v-model="ruleForm.native_place" placeholder="请输入社员籍贯" clearable></el-input>
                </el-form-item>
                <el-form-item label="民族:" prop="nation_id">
                    <el-select v-model="ruleForm.nation_id" placeholder="请选择社员民族">
                ...
                <el-form-item label="户口类型:" prop="permanent_type">
                    <el-select v-model="ruleForm.permanent_type" placeholder="请选择户口类型">
                        <el-option label="农业户口" value="1"></el-option>
                        <el-option label="城镇户口" value="2"></el-option>
                    </el-select>
                </el-form-item>
                 <el-form-item label="手机号:" prop="phone">
                    <el-input v-model="ruleForm.phone" placeholder="请输入社员手机号" clearable :readonly="!checkTelLoading"></el-input>
                </el-form-item>
                 <el-form-item label="学历:" prop="edu_id">
                    <el-select v-model="ruleForm.edu_id" placeholder="请选择社员学历">
                        <el-option v-for="(item,index) in eduOptions" :key="index" :label="item.name" :value="item.edu_id"></el-option>
                    </el-select>
                </el-form-item>
                 <el-form-item label="政治面貌:" prop="political_outlook_id">
                    <el-select v-model="ruleForm.political_outlook_id" placeholder="请选择社员政治面貌">
                ...
                <el-form-item class="upload-con" prop="photo" >
                    <div class="img-con">
                        <img id="devPhoto2" :src="ruleForm.photo ? ruleForm.photo : defaultPhoto" @click="showImgView(ruleForm.photo)" alt="">
                    </div>
            ...
            <div class="form-item-con clearfix">
                <el-form-item label="出资类型:" prop="zi_id">
                    <el-select v-model="ruleForm.zi_id" placeholder="请选择出资类型">
                        <el-option v-for="(item,index) in ziOptions" :key="index" :label="item.name" :value="item.id"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="出资金额:" prop="money">
                    <el-input v-model="ruleForm.money" placeholder="请输入出资金额" clearable></el-input>
                </el-form-item>
                <el-form-item label="股金类型:" prop="guaran_id">
                    <el-select v-model="ruleForm.guaran_id" placeholder="请选择股金类型">
                        <el-option v-for="(item,index) in guaranOptions" :key="index" :label="item.name" :value="item.id"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="备注:" prop="note">
                    <el-input v-model="ruleForm.note" placeholder="请输入备注" clearable></el-input>
                </el-form-item>
                <el-form-item label="相关资料上传:" class="assets-form-item">
                     <template  v-if="ruleForm.imgs && ruleForm.imgs.length > 0">
                        <div class="pic-item" v-for="(imgItem,imgIndex) in ruleForm.imgs" :key="imgIndex" >
            ...
            <div class="form-item-con clearfix">
                <el-form-item label="工作单位:" prop="work_unit">
                    <el-input v-model="ruleForm.work_unit" placeholder="请输入社员工作单位" clearable></el-input>
                </el-form-item>
                <el-form-item label="从事行业:" prop="occ_id">
                    <el-select v-model="ruleForm.occ_id" placeholder="请选择社员从事行业">
                ...
                <el-form-item label="工作职位:" prop="position">
                    <el-input v-model="ruleForm.position" placeholder="请输入社员工作职位" clearable></el-input>
                </el-form-item>
            </div>
            <!-- <div v-for="(item,index) in ruleForm.familys" :key="index">
                <div class="tit-con">
                    ...
                    <div class="bg"></div>
                    <img v-if="index > 0" class="del-family-icon" src="../../images/baseInfo/del-family.png" @click="delFamily(index)" alt="">
                </div>
                <div class="form-item-con clearfix">
                    <el-form-item label="姓名:"   >
                        <el-input v-model="item.name" placeholder="请输入家庭成员姓名" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="出生年月:" >
                        <el-date-picker type="date" placeholder="请选择家庭成员出生年月" v-model="item.birth_date" style="width: 80%;"></el-date-picker>
                    </el-form-item>
                    <el-form-item label="与本人关系:" >
                        <el-input v-model="item.user_relation" placeholder="请输入家庭成员与本人关系" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="联系方式:" >
                        <el-input v-model="item.mobile" placeholder="请输入家庭成员联系方式" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="证件号码:" >
                        <el-input v-model="item.idcard" placeholder="请输入家庭成员证件号码" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="工作单位:" >
                        <el-input v-model="item.work_unit" placeholder="请输入家庭成员工作单位" clearable></el-input>
                    </el-form-item>
                </div>
            </div> -->
            <!-- <div class="add-family-con" @click="addFamily()">
                <img width="100%" src="../../images/baseInfo/add-family.png" alt="">
            </div> -->
            <div class="btn-con">
                <el-button type="primary" round @click="submitForm('ruleForm')" :loading="submitLoading">{{submitLoading ? '提交中...' : '立即创建'}}</el-button>
            </div>
        </el-form>
        <el-form v-if="confrere_attr == 2" ref="licenceForm" :model="licenceForm" :rules="licenceRules" style="margin-top: 0.5rem" label-width="100px">
            <div class="tit-con">
                <div class="shu"></div>
            ...
            <div class="form-item-con clearfix">
                <el-form-item label="社员类型:" prop="coopera_cls">
                    <el-select v-model="licenceForm.coopera_cls" placeholder="请选择社员类型">
                        <el-option v-for="(item,index) in confrereTypeOptions" :key="index" :label="item.name" :value="item.id"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="机构名称:" prop="short_name">
                    <el-input v-model="licenceForm.short_name" placeholder="请输入机构名称" clearable></el-input>
                </el-form-item>
                <el-form-item label="机构地址:" prop="address">
                    <el-input v-model="licenceForm.address" placeholder="请输入地址" clearable></el-input>
                </el-form-item>
                <el-form-item label="社会信用代码:" prop="license_num">
                    <el-input v-model="licenceForm.license_num" placeholder="请输入社会信用代码" clearable></el-input>
                </el-form-item>
                <el-form-item label="成立日期:" prop="license_start">
                    <el-date-picker type="date" value-format="yyyy-MM-dd" placeholder="请选择成立日期" v-model="licenceForm.license_start" style="width: 80%;"></el-date-picker>
                </el-form-item>
                 <el-form-item label="营业有效期:" prop="license_end">
                    <el-date-picker type="date" value-format="yyyy-MM-dd" placeholder="请选择营业有效期" v-model="licenceForm.license_end" style="width: 80%;"></el-date-picker>
                </el-form-item>
                <el-form-item label="法人姓名:" prop="legal_person">
                    <el-input v-model="licenceForm.legal_person" placeholder="请输入法人姓名" clearable></el-input>
                </el-form-item>
                <el-form-item label="法人手机号:" prop="phone">
                    <el-input v-model="licenceForm.phone" placeholder="请输入法人手机号" clearable :readonly="!checkTelLoading"></el-input>
                </el-form-item>
                ...
                <el-form-item label="法人身份证正面:" prop="idcard_just" class="idcard-item-con">
                    <div class="idcard-img-con">
                ...
                <el-form-item label="法人身份证反面:" prop="idcard_reverse" class="idcard-item-con">
                   <div class="idcard-img-con">
            ...
            <div class="form-item-con clearfix">
                <el-form-item label="出资类型:" prop="zi_id">
                    <el-select v-model="licenceForm.zi_id" placeholder="请选择出资类型">
                        <el-option v-for="(item,index) in ziOptions" :key="index" :label="item.name" :value="item.id"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="出资金额:" prop="money">
                    <el-input v-model="licenceForm.money" placeholder="请输入出资金额" clearable></el-input>
                </el-form-item>
                <el-form-item label="股金类型:" prop="guaran_id">
                    <el-select v-model="licenceForm.guaran_id" placeholder="请选择股金类型">
                        <el-option v-for="(item,index) in guaranOptions" :key="index" :label="item.name" :value="item.id"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="备注:" prop="note">
                    <el-input v-model="licenceForm.note" placeholder="请输入备注" clearable></el-input>
                </el-form-item>
                <el-form-item label="相关资料上传:" class="assets-form-item">
                     <template  v-if="licenceForm.imgs && licenceForm.imgs.length > 0">
                        <div class="pic-item" v-for="(imgItem,imgIndex) in licenceForm.imgs" :key="imgIndex" >
                            <img @click="showImgView(imgItem.url)" class="pic" :src="imgItem.url" alt="">
                             <div v-if="imgItem.status && imgItem.status !='done'" style="position:absolute;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.6);display:flex;align-items:center;justify-content:center;flex-direction:column">
                                <i style="color:#fff;font-size:1.5rem" :class="imgItem.status == 'uploading' ? 'el-icon-loading' : 'el-icon-circle-close'"></i>
                                <span style="color:#fff;font-size:1rem">{{imgItem.status == 'uploading' ? '上传中...' : '上传失败'}}</span>
                            </div>
                            <img v-if="imgItem.status && imgItem.status !='uploading'" @click.stop="delLicenseImgItem(imgIndex)" style="position:absolute; top:0;right:0;transform:translate(50%, -50%);width:20px;height:20px;cursor:pointer" src="/static/img/iframe-close.png" alt="">
                        </div>
                    </template>
                    <el-button style="float:left" plain type="primary" size="small" @click="licenseScanUpload()" >扫描上传</el-button>
                </el-form-item>
            </div> -->
             <div class="btn-con">
                <el-button type="primary" round @click="licenceSubmitForm('licenceForm')" :loading="licenceSubmitLoading">{{licenceSubmitLoading ? '提交中...' : '立即创建'}}</el-button>
            </div>
        </el-form>
        <el-form v-if="confrere_attr == 3" ref="orgForm" :model="orgForm" :rules="orgRules" style="margin-top: 0.5rem" label-width="100px">
            <div class="tit-con">
                <div class="shu"></div>
                <span class="tit">集体经济组织建档</span>
                <div class="bg"></div>
            </div>
            <div class="form-item-con clearfix">
                <el-form-item label="社员类型:" prop="coopera_cls">
                    <el-select v-model="orgForm.coopera_cls" placeholder="请选择社员类型">
                        <el-option v-for="(item,index) in confrereTypeOptions" :key="index" :label="item.name" :value="item.id"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="组织名称:" prop="short_name">
                    <el-input v-model="orgForm.short_name" placeholder="请输入组织名称" clearable></el-input>
                </el-form-item>
                <el-form-item label="组织地址:" prop="address">
                    <el-input v-model="orgForm.address" placeholder="请输入地址" clearable></el-input>
                </el-form-item>
                <el-form-item label="社会信用代码:" prop="license_num">
                    <el-input v-model="orgForm.license_num" placeholder="请输入社会信用代码" clearable></el-input>
                </el-form-item>
                <el-form-item label="成立日期:" prop="license_start">
                    <el-date-picker type="date" value-format="yyyy-MM-dd" placeholder="请选择成立日期" v-model="orgForm.license_start" style="width: 80%;"></el-date-picker>
                </el-form-item>
                 <el-form-item label="营业有效期:" prop="license_end">
                    <el-date-picker type="date" value-format="yyyy-MM-dd" placeholder="请选择营业有效期" v-model="orgForm.license_end" style="width: 80%;"></el-date-picker>
                </el-form-item>
                <el-form-item label="单位电话:" prop="mobile">
                    <el-input v-model="orgForm.mobile" placeholder="请输入单位电话" clearable></el-input>
                </el-form-item>
                <el-form-item label="业务范围:" prop="scope">
                    <el-input v-model="orgForm.scope" placeholder="请输入业务范围" clearable></el-input>
                </el-form-item>
                <el-form-item label="法人姓名:" prop="legal_person">
                    <el-input v-model="orgForm.legal_person" placeholder="请输入法人姓名" clearable></el-input>
                </el-form-item>
                <el-form-item label="法人手机号:" prop="phone">
                    <el-input v-model="orgForm.phone" placeholder="请输入法人手机号" clearable :readonly="!checkTelLoading"></el-input>
                </el-form-item>
                <el-form-item label="法人身份证正面:" prop="idcard_just" class="idcard-item-con">
                    <div class="idcard-img-con">
            ...
            <div class="form-item-con clearfix">
                <el-form-item label="出资类型:" prop="zi_id">
                    <el-select v-model="orgForm.zi_id" placeholder="请选择出资类型">
                        <el-option v-for="(item,index) in ziOptions" :key="index" :label="item.name" :value="item.id"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="出资金额:" prop="money">
                    <el-input v-model="orgForm.money" placeholder="请输入出资金额" clearable></el-input>
                </el-form-item>
                <el-form-item label="股金类型:" prop="guaran_id">
                    <el-select v-model="orgForm.guaran_id" placeholder="请选择股金类型">
                        <el-option v-for="(item,index) in guaranOptions" :key="index" :label="item.name" :value="item.id"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="备注:" prop="note">
                    <el-input v-model="orgForm.note" placeholder="请输入备注" clearable></el-input>
                </el-form-item>
                <el-form-item label="相关资料上传:" class="assets-form-item">
                     <template  v-if="orgForm.imgs && orgForm.imgs.length > 0">
                        <div class="pic-item" v-for="(imgItem,imgIndex) in orgForm.imgs" :key="imgIndex" >
                            <img @click="showImgView(imgItem.url)" class="pic" :src="imgItem.url" alt="">
                             <div v-if="imgItem.status && imgItem.status !='done'" style="position:absolute;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.6);display:flex;align-items:center;justify-content:center;flex-direction:column">
                                <i style="color:#fff;font-size:1.5rem" :class="imgItem.status == 'uploading' ? 'el-icon-loading' : 'el-icon-circle-close'"></i>
                                <span style="color:#fff;font-size:1rem">{{imgItem.status == 'uploading' ? '上传中...' : '上传失败'}}</span>
             ...
             <div class="btn-con">
                <el-button type="primary" round @click="orgSubmitForm('orgForm')" :loading="orgSubmitLoading">{{orgSubmitLoading ? '提交中...' : '立即创建'}}</el-button>
            </div>
        </el-form>
        ...
        <div class="iframe-absolute-con" v-if="showIframe" @click="showIframe = false">
            <iframe @click.stop=""  class="scan-iframe" id="iframeId" src="./static/scanSubPhoto.html?path=addConfrere" frameborder="0"></iframe>
        </div> 
        <div class="iframe-absolute-con" v-if="showReadIframe" @click="showReadIframe = false">
            <iframe @click.stop=""  class="scan-iframe2" id="readIframeId" src="./static/readCert.html?path=addConfrereread" frameborder="0"></iframe>
        </div> 
        <div class="iframe-absolute-con" v-if="showAssetsIframe" @click="showAssetsIframe = false">
            <iframe @click.stop=""  class="scan-iframe3" id="assetsIframeId" src="./static/scanPrimaryPhoto.html?path=addConfrereassets" frameborder="0"></iframe>
        </div>
         <div class="iframe-absolute-con" v-if="showLicenseIframe" @click="showLicenseIframe = false">
            <iframe @click.stop=""  class="scan-iframe3" id="licenseIframeId" src="./static/scanPrimaryPhoto.html?path=addConfrereLicense" frameborder="0"></iframe>
        </div>
        <div class="iframe-absolute-con" v-if="showLicenseReadIframe" @click="showLicenseReadIframe = false">
            <iframe @click.stop=""  class="scan-iframe2" id="licenseReadIframeId" src="./static/readCert.html?path=addConfrereLicenseread" frameborder="0"></iframe>
        </div> 
        <div class="iframe-absolute-con" v-if="showLicenseReadFIframe" @click="showLicenseReadFIframe = false">
            <iframe @click.stop=""  class="scan-iframe2" id="licenseReadFIframeId" src="./static/readCert.html?path=addConfrereLicenseFread" frameborder="0"></iframe>
        </div> 

        <div class="iframe-absolute-con" v-if="showLicenseAssetsIframe" @click="showLicenseAssetsIframe = false">
            <iframe @click.stop=""  class="scan-iframe3" id="licenseAssetsIframeId" src="./static/scanPrimaryPhoto.html?path=addConfrereLicenseassets" frameborder="0"></iframe>
        </div>

        <div class="iframe-absolute-con" v-if="showReadZIframe" @click="showReadZIframe = false">
            <iframe @click.stop=""  class="scan-iframe2" id="readZIframeId" src="./static/readCert.html?path=addConfrereZread" frameborder="0"></iframe>
        </div>
        <div class="iframe-absolute-con" v-if="showReadFIframe" @click="showReadFIframe = false">
            <iframe @click.stop=""  class="scan-iframe2" id="readFIframeId" src="./static/readCert.html?path=addConfrereFread" frameborder="0"></iframe>
        </div>

         <div class="iframe-absolute-con" v-if="showOrgIframe" @click="showOrgIframe = false">
            <iframe @click.stop=""  class="scan-iframe3" id="orgIframeId" src="./static/scanPrimaryPhoto.html?path=addConfrereOrg" frameborder="0"></iframe>
        </div>
        <div class="iframe-absolute-con" v-if="showOrgReadIframe" @click="showOrgReadIframe = false">
            <iframe @click.stop=""  class="scan-iframe2" id="orgReadIframeId" src="./static/readCert.html?path=addConfrereOrgread" frameborder="0"></iframe>
        </div> 
        <div class="iframe-absolute-con" v-if="showOrgReadFIframe" @click="showOrgReadFIframe = false">
            <iframe @click.stop=""  class="scan-iframe2" id="orgReadFIframeId" src="./static/readCert.html?path=addConfrereOrgFread" frameborder="0"></iframe>
        </div>
...
export default {
  ...
  data() {
    ...
    return {
        ...
        checkData: null, // 验证手机号返回的数据
        checkTelLoading: false, // 手机号验证loading
        isShowCheckTelDialog: true,// 检查手机号dialog弹窗

        confrere_attr: null, // 1-自然人 2-机构
        ...
        showOrgIframe: false, //组织登记证识别iframe弹窗
        uploadOrgBase64: '', //组织登记证base64
        uploadOrgErr:false, // 识别组织登记证信息失败
        uploadOrgLoading: false,// 识别组织登记证信息loading

        showOrgReadIframe: false, // 法人身份证识别iframe弹窗
        uploadOrgIdcardBase64: '', // 法人身份证base64
        uploadOrgIdCardLoading: false, //上传法人身份证loading
        uploadOrgIdCardErr: false, //上传法人身份证err

        showOrgReadFIframe: false, // 法人身份证反面iframe弹窗
        uploadOrgIdcardFBase64: '', // 法人身份证反面base64
        uploadOrgIdCardFLoading: false, //上传法人身份证反面loading
        uploadOrgIdCardFErr: false, //上传法人身份证反面err
  ...
  created() {
    window.addEventListener("message",(event)=>{
        //自然人上传照片
        if(event.data && event.data.path && event.data.path == 'addConfrere') {
        ...
        // 自然人身份证正面识别
        if(event.data && event.data.path && event.data.path == 'addConfrereZread') {
            if(event.data.type == 'data') {
        ...
        // 自然人身份证反面上传
        if(event.data && event.data.path && event.data.path == 'addConfrereFread') {
            if(event.data.type == 'data') {
        ...
        // 自然人点击读身份证
        if(event.data && event.data.path && event.data.path == 'addConfrereread') {
            if(event.data.type == 'data') {
        ...
        // 自然人扫描资产上传
        if(event.data && event.data.path && event.data.path == 'addConfrereassets') {
            if(event.data.type == 'data') {
        ...
        // 机构识别营业执照
         if(event.data && event.data.path && event.data.path == 'addConfrereLicense') {
            if(event.data.type == 'data') {
        ...
        // 法人身份证上传
         if(event.data && event.data.path && event.data.path == 'addConfrereLicenseread') {
            if(event.data.type == 'data') {
        ...
        // 法人身份证反面上传
         if(event.data && event.data.path && event.data.path == 'addConfrereLicenseFread') {
            if(event.data.type == 'data') {
        ...
        // 机构扫描资产上传
         if(event.data && event.data.path && event.data.path == 'addConfrereLicenseassets') {
            if(event.data.type == 'data') {
        ...
        // 集体经济组织识别登记证
         if(event.data && event.data.path && event.data.path == 'addConfrereOrg') {
            if(event.data.type == 'data') {
        ...
        // 集体经济组织法人身份证上传
         if(event.data && event.data.path && event.data.path == 'addConfrereOrgread') {
            if(event.data.type == 'data') {
        ...
        // 集体经济组织法人身份证反面上传
         if(event.data && event.data.path && event.data.path == 'addConfrereOrgFread') {
            if(event.data.type == 'data') {
  ...
  methods: {
    ...
    // 选择社员属性
    changeConfrereAttr(type) {
        this.confrere_attr = type
        let data = this.checkData
        if(data) {
            if(type == 1) {
                this.ruleForm = {
                    cls: type,
                    coopera_cls: data.coopera_cls ? data.coopera_cls : null,
                    name: data.name,
                    sex: data.sex+'',
                    birth_date: data.birth_date ? data.birth_date.substring(0,10) : '',
                    native_place: data.native_place,
                    photo: data.photo,
                    idcard_just: data.idcard_just,
                    idcard_reverse: data.idcard_reverse,
                    idcard: data.idcard,
                    nation_id: data.nation_id ? data.nation_id : null,
                    permanent_type: data.permanent_type ? (data.permanent_type+'') : null,
                    edu_id: data.edu_id ? data.edu_id : null, 
                    political_outlook_id: data.political_outlook_id ? data.political_outlook_id : null,
                    phone: this.checkTelForm.regTel,
                    work_unit: data.work_unit,
                    position: data.position,
                    occ_id: data.occ_id ? data.occ_id : null,
                    familys: data.familys && data.familys.length > 0 ? data.familys : [],
                }
            }else if(type == 2) {
                this.licenceForm = {
                    cls: type,
    ...
    scanUpload() {
        ...
        setTimeout(() =>{
            document.getElementById('assetsIframeId').src='./static/scanPrimaryPhoto.html?path=addConfrereassets';
        },500)
    },
    // 机构扫描资产上传
    licenseScanUpload() {
        ...
        setTimeout(() =>{
            document.getElementById('licenseAssetsIframeId').src='./static/scanPrimaryPhoto.html?path=addConfrereLicenseassets';
        },500)
    },
    // 删除自然人当前资产img
    delImgItem(index) {
        ...
        if(this.uploadLicenseIdCardErr) {
             this.$confirm('请选择重新上传或重新拍照?', '提示', {
                ...
                type: 'warning'
                    ...
                    setTimeout(() =>{
                        document.getElementById('licenseReadIframeId').src='./static/readCert.html?path=addConfrereLicenseread';
                    },500)
            });
            return
        }
        ...
        if(this.uploadOrgIdCardErr) {
             this.$confirm('请选择重新上传或重新拍照?', '提示', {
                ...
                type: 'warning'
                    ...
                    setTimeout(() =>{
                        document.getElementById('orgReadIframeId').src='./static/readCert.html?path=addConfrereOrgread';
                    },500)
            });
            return
        }
        ...
        if(this.uploadLicenseIdCardFErr) {
             this.$confirm('请选择重新上传或重新拍照?', '提示', {
                ...
                type: 'warning'
                    ...
                    setTimeout(() =>{
                        document.getElementById('licenseReadFIframeId').src='./static/readCert.html?path=addConfrereLicenseFread';
                    },500)
            });
            return
        }
        ...
        if(this.uploadOrgIdCardFErr) {
             this.$confirm('请选择重新上传或重新拍照?', '提示', {
                ...
                type: 'warning'
                    ...
                    setTimeout(() =>{
                        document.getElementById('orgReadFIframeId').src='./static/readCert.html?path=addConfrereOrgFread';
                    },500)
            });
            return
        }
    ...
    licenseBase64Upload(base64) {
        ...
        that.ajax('licenseBase64',{
            ...
            if(res.errno == 0) {
                ...
                that.licenceForm.legal_person = data.legal_person
    ...
    orgBase64Upload(base64) {
        ...
        that.ajax('licenseBase64',{
            ...
            if(res.errno == 0) {
                ...
                that.orgForm.legal_person = data.legal_person
        ...
        if(this.uploadLicenseErr) {
             this.$confirm('请选择重新上传或重新拍照?', '提示', {
                ...
                type: 'warning'
                    ...
                    setTimeout(() =>{
                        document.getElementById('licenseIframeId').src='./static/scanPrimaryPhoto.html?path=addConfrereLicense';
                    },500)
            });
            return
        }
        ...
        if(this.uploadErr) {
             this.$confirm('请选择重新上传或重新拍照?', '提示', {
                ...
                type: 'warning'
                    ...
                    setTimeout(() =>{
                        document.getElementById('iframeId').src='./static/scanSubPhoto.html?path=addConfrere';
                    },500)
            });
            return
        }
        ...
        if(this.uploadOrgErr) {
             this.$confirm('请选择重新上传或重新拍照?', '提示', {
                ...
                type: 'warning'
                    ...
                    setTimeout(() =>{
                        document.getElementById('orgIframeId').src='./static/scanPrimaryPhoto.html?path=addConfrereOrg';
                    },500)
            });
            return
        }
        ...
        if(this.uploadIdCardZErr) {
            this.$confirm('请选择重新上传或重新拍照?', '提示', {
                ...
                type: 'warning'
                    ...
                    setTimeout(() =>{
                        document.getElementById('readZIframeId').src='./static/readCert.html?path=addConfrereZread';
                    },500)
            });
            return
        }
        ...
        if(this.uploadIdCardFErr) {
            this.$confirm('请选择重新上传或重新拍照?', '提示', {
                ...
                type: 'warning'
                    ...
                    setTimeout(() =>{
                        document.getElementById('readFIframeId').src='./static/readCert.html?path=addConfrereFread';
                    },500)
            });
            return
        }
        ...
        if(this.uploadIdCardErr) {
            this.$confirm('请选择重新上传或重新拍照?', '提示', {
                ...
                type: 'warning'
                    ...
                    setTimeout(() =>{
                        document.getElementById('readIframeId').src='./static/readCert.html?path=addConfrereread';
                    },500)
            });
            return
        }
    ...
    initData() {
        ...
        this.isShowCheckTelDialog = true// 检查手机号di
        this.submitLoading = false // 自然人提交创建loading
        this.initBase64()
        this.getNationList()
        this.getEduList()
    ...
    submitForm(formName) {
        ...
        that.$refs[formName].validate((valid) => {
          if (valid) {
              ...
              that.ajax('addUser',params,'自然人建档失败',res =>{
                that.submitLoading = false
                if(res.errno == 0) {
                    that.$message.success('自然人建档成功,请去社员档案查看')
                    that.checkTelForm.regTel = ''
                    that.resetForm(formName)
                    that.ruleForm.idcard_just = ''
                    that.ruleForm.idcard_reverse = ''
                    that.ruleForm.photo = ''
                    that.ruleForm.permanent_type = ''
                    that.ruleForm.birth_date = ''
                    that.ruleForm.familys = []
                    that.ruleForm.name = ''
                    that.ruleForm.imgs = []
                    that.isShowCheckTelDialog = true;// 检查手机号dialog弹窗
                    that.confrere_attr = null;// 1-自然人 2-机构
                    that.initBase64()
                    that.$forceUpdate()
                }
              }, err =>{
      ...
      licenceSubmitForm(formName) {
        ...
        that.$refs[formName].validate((valid) => {
          if (valid) {
              ...
              that.ajax('licenceadd',params,'机构建档失败',res =>{
                that.licenceSubmitLoading = false
                if(res.errno == 0) {
                    that.$message.success('机构建档成功,请去社员档案查看')
                    that.checkTelForm.regTel = ''
                    that.resetForm(formName)
                    that.licenceForm.idcard_just = ''
                    that.licenceForm.idcard_reverse = ''
                    that.licenceForm.photo = ''
                    that.isShowCheckTelDialog = true;// 检查手机号dialog弹窗
                    that.confrere_attr = null;// 1-自然人 2-机构
                    that.initBase64()
                    that.$forceUpdate()
      ...
      orgSubmitForm(formName) {
        ...
        that.$refs[formName].validate((valid) => {
          if (valid) {
              ...
              that.ajax('collectiveAdd',params,'集体经济组织建档失败',res =>{
                that.orgSubmitLoading = false
                if(res.errno == 0) {
                    that.$message.success('集体经济组织建档成功,请去社员档案查看')
                    that.checkTelForm.regTel = ''
                    that.resetForm(formName)
                    that.orgForm.idcard_just = ''
                    that.orgForm.idcard_reverse = ''
                    that.orgForm.photo = ''
                    that.isShowCheckTelDialog = true;// 检查手机号dialog弹窗
                    that.confrere_attr = null;// 1-自然人 2-机构
                    that.initBase64()
      ...
      // 初始化表单数据
      initForm() {
        this.ruleForm.idcard_just = ''
        this.ruleForm.idcard_reverse = ''
        this.ruleForm.photo = ''
        this.ruleForm.permanent_type = ''
        this.ruleForm.birth_date = ''
        this.ruleForm.familys = []
        this.ruleForm.name = ''
        this.ruleForm.imgs = []
        this.licenceForm.idcard_just = ''
        this.licenceForm.idcard_reverse = ''
        this.licenceForm.photo = ''
        this.orgForm.idcard_just = ''
        this.orgForm.idcard_reverse = ''
        this.orgForm.photo = ''
      },
      // 验证注册手机号
          ...
          if (valid) {
              ...
              that.ajax('checkTel',{
                ...
                if(res.errno == 0) {   
                    ...
                    that.$message.success('手机号还未注册,请选择社员属性注册')
                } else if(res.errno == 2) {
                    that.$message.error('该手机已注册')
                    that.checkTelForm.regTel = ''
                } else if(res.errno == 3) { // 无员工与社员注册信息
                    that.ruleForm.phone =  that.checkTelForm.regTel
                    that.orgForm.phone =  that.checkTelForm.regTel
                    that.licenceForm.phone =  that.checkTelForm.regTel
                    that.isShowCheckTelDialog = false
                    that.checkData = null
                    that.$message.success('手机号还未注册,请选择社员属性注册')
                } else {
