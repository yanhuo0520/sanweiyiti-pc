            ...
            <div class="breadcrumb-con">
                ...
                <div class="breadcrumb-info">
                    <el-breadcrumb separator-class="el-icon-arrow-right">
                        ...
                        <el-breadcrumb-item  class="breadcrumb-tit">股金退股</el-breadcrumb-item>
                    </el-breadcrumb>
                </div>
            </div>
            ...
            <template v-if="info.relation_id">
              ...
              <div class="form-item-con clearfix">
                  ...
                  <el-form-item label="存入金额:">
                      <el-input v-model="info.stock_money" clearable readonly></el-input>
                  </el-form-item>
              </div>
              ...
              <div class="form-item-con clearfix">
                  <el-form-item label="支取金额:">
                      <el-input v-model="info.stock_money" placeholder="请输入支取金额" clearable @input="inputMoney" readonly></el-input>
                  </el-form-item>
            ...
            <el-form ref="ruleForm" label-width="150px">
                ...
                <div class="form-item-con clearfix">
                    <el-form-item label="定期账号（卡号）:">
                        <el-input v-model="stock_num" placeholder="请输入互助金卡号" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="社员姓名:">
                        <el-input v-model="info.name" clearable readonly></el-input>
                    </el-form-item>
...
export default {
  ...
  methods: {
    ...
    submitForm(){
        ...
        param.save_type_id = 1
        param.pwd = this.utils.recursiveMD5(this.password, 1)
        param.id = 0
        param.money = this.info.stock_money
        param.interest = 0
        if(!this.isFind){
