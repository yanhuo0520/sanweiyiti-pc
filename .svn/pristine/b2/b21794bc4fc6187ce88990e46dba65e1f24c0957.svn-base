    ...
    <div class="addGoods" v-loading="loading">
        <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="150px">
            ...
            <el-table
             ...
             <el-button type="primary" @click="addGuige" v-if="$route.query.tag=='edit'" style="display:block;margin: 20px auto;">添加规格</el-button>
        ...
        <el-dialog title="阶梯价格" :visible.sync="isAddPrice">
            <div style="height:60vh;overflow-y:auto;">
              <div class="list" v-for="(item,index) in priceList" :key="'info-'+ index">
                ...
                <p>价格：<el-input v-model="item.price" type="tel" @input="item.price=item.price.replace(/^\D*(\d*(?:\.\d{0,2})?).*$/g,'$1')"></el-input> 元</p>
...
export default {
  ...
  computed: {
    ...
    specArr:{
      ...
      console.log(this.ruleForm.spcifi)
      return arr
      },
      set(val){
