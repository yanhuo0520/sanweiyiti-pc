<template>
    <div class="organizationList" v-loading="loading">
        <div class="breadcrumb-con">
            <img class="left-icon" src="../../images/breadcrumb-left-icon.png" alt="">
            <div class="breadcrumb-info">
                <el-breadcrumb separator-class="el-icon-arrow-right">
                    <el-breadcrumb-item>机构管理</el-breadcrumb-item>
                    <el-breadcrumb-item :to="{ path: 'organizationList' }">机构列表</el-breadcrumb-item>
                     <el-breadcrumb-item v-if="parentName" class="breadcrumb-tit">【{{parentName}}】下的合作社列表</el-breadcrumb-item>
                </el-breadcrumb>
            </div>
          ...
          <div class="search-con">
            <el-form class="clearfix"  label-width="100px">
                <el-form-item label="合作社名称">
                  <el-input v-model="cooperaName" placeholder="请输入合作社名称" clearable @clear="clearCooperName"></el-input>
                </el-form-item>
