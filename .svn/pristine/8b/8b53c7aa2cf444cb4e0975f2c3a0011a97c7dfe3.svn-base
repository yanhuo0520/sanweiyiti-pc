    ...
    <div class="assortList" v-loading="loading">
        ...
        <div class="table-con">
            <div >
              ...
              <el-table-column prop="log_date" label="操作" v-if="isEdit || isDel" width="220" align="center">
                  <template slot-scope="scope">
                      <el-button type="primary" plain v-if="isEdit" size="small" @click="edit(scope.row.assort_id,scope.row.assort_name,scope.row.icon)">编辑</el-button>
                      <el-button type="danger" plain v-if="isDel" size="small" @click="del(scope.row.assort_id)">删除</el-button>
                  </template>
              </el-table-column>
              </el-table>
