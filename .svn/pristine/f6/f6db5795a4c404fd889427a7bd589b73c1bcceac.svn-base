<template>
    <div class="assortList" v-loading="loading">
        ...
        <div class="table-con">
            <div>
              <el-table :data="tableData" border v-if="tableData && tableData.length > 0">
                ...
                <el-table-column prop="log_date" label="操作" width="180" align="center">
                    <template slot-scope="scope">
                        <el-button  type="primary" plain size="small" @click="edit(scope.row.assort_id,scope.row.assort_name,scope.row.icon)">编辑</el-button>
                        <el-button type="danger"  plain size="small" @click="del(scope.row.assort_id)">删除</el-button>
                    </template>
                </el-table-column>
              </el-table>
